...
class Maid extends CI_Controller {
	...
	$data = array(
		...
		'voter_id_proof' =>$this->input->post('voter_id_proof'),
		'aadhaar_id_proof' =>$this->input->post('aadhaar_id_proof'),
		'permanent_address' =>$this->input->post('permanent_address'),
		'current_residance' =>$this->input->post('current_residance'),
		'mothers_name' =>$this->input->post('mothers_name'),
		'fathers_husband_name' =>$this->input->post('fathers_husband_name'),
		'children_no' =>$this->input->post('children_no'),
    ...
    $url = 'http://webdesignagencynewyork.com/dev/cleanomate/api/maid/createmaid';
	...
	$result=json_decode($this->request($data,$url,$header_data));
	$this->session->set_flashdata('message', 'Maid details added succefully!');
